...
MODELS = [
    ...
    ("stage-c-xgb-top20-tune-tuned", "model-20260501-203818", "xgboost_paper",
     None),
    ("stage-c-chebykan-top20-tune-tuned", "model-20260501-203940", "kan_paper",
     "sweeps/stage_c/chebykan/20_features/stage-c-chebykan-top20-tune_best.yaml"),
    ("stage-c-fourierkan-top20-tune-tuned", "model-20260501-204051", "kan_paper",
     "sweeps/stage_c/fourierkan/20_features/stage-c-fourierkan-top20-tune_best.yaml"),
