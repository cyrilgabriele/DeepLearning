...
MODELS = [
    ...
    ("stage-c-xgb-top20", "model-20260424-144138", "kan_paper",
     None),
    ("stage-c-xgb-top20-tune-tuned", "model-20260501-203818", "xgboost_paper",
     None),
    ("stage-c-chebykan-top20-pareto-sparsity-trial-029", "model-20260502-000204", "kan_paper",
     "sweeps/stage_c/chebykan/20_features/stage-c-chebykan-top20-pareto-sparsity_pareto_trial029.yaml"),
    ("stage-c-fourierkan-top20-pareto-sparsity-trial-017", "model-20260502-005250", "kan_paper",
     "sweeps/stage_c/fourierkan/20_features/stage-c-fourierkan-top20-pareto-sparsity_pareto_trial017.yaml"),
